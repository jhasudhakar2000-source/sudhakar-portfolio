    ...
    <article className="bg-black">
        ...
        <div className="page-shell py-16 sm:py-24 lg:py-16">
          <div className="grid items-center gap-12 lg:items-start lg:grid-cols-[minmax(0,0.9fr)_minmax(24rem,0.72fr)] lg:gap-12">
            ...
            <div className="justify-self-center lg:justify-self-end">
              <div className="overflow-hidden rounded-[1.35rem] bg-[#090909] shadow-[0_2rem_5rem_rgba(0,0,0,0.5)]">
                <video
      ...
      <section className="border-b border-white/10" aria-labelledby="showcase-title">
        <div className="page-shell py-24 sm:py-32 lg:py-40">
          ...
          <div className="mx-auto max-w-[48rem] overflow-hidden rounded-[1.5rem] bg-[#090909]">
            <video
              ...
              preload="metadata"
              poster={media.thumbnail}
              aria-label={`${project.title} final film`}
            >
              <source src={media.video} type="video/mp4" />
            </video>
          </div>
    ...
    <article className="bg-black">
      ...
      <section className="border-b border-white/10" aria-labelledby="showcase-title">
        <div className="page-shell py-24 sm:py-32 lg:py-40">
          ...
          <div className="overflow-hidden rounded-[1.5rem] bg-[#090909]">
            <video
              className="block h-auto w-full"
              controls
              playsInline
